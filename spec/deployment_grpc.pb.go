...
type ProvisionerClient interface {
	...
	DriverGrantDeploymentAccess(ctx context.Context, in *DriverGrantDeploymentAccessRequest, opts ...grpc.CallOption) (*DriverGrantDeploymentAccessResponse, error)
	// This call revokes all access to a particular deployment from a principal.
	DriverRevokeDeploymentAccess(ctx context.Context, in *DriverRevokeDeploymentAccessRequest, opts ...grpc.CallOption) (*DriverRevokeDeploymentAccessResponse, error)
}
...
func (c *provisionerClient) DriverGrantDeploymentAccess(ctx context.Context, in *DriverGrantDeploymentAccessRequest, opts ...grpc.CallOption) (*DriverGrantDeploymentAccessResponse, error) {
	out := new(DriverGrantDeploymentAccessResponse)
	err := c.cc.Invoke(ctx, "/deployment.v1alpha1.Provisioner/DriverGrantDeploymentAccess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *provisionerClient) DriverRevokeDeploymentAccess(ctx context.Context, in *DriverRevokeDeploymentAccessRequest, opts ...grpc.CallOption) (*DriverRevokeDeploymentAccessResponse, error) {
	out := new(DriverRevokeDeploymentAccessResponse)
	err := c.cc.Invoke(ctx, "/deployment.v1alpha1.Provisioner/DriverRevokeDeploymentAccess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProvisionerServer interface {
	...
	// This call grants access to an account. The account_name in the request shall be used as a unique identifier to create credentials.
	// The account_id returned in the response will be used as the unique identifier for deleting this access when calling DriverRevokeDeploymentAccess.
	DriverGrantDeploymentAccess(context.Context, *DriverGrantDeploymentAccessRequest) (*DriverGrantDeploymentAccessResponse, error)
	// This call revokes all access to a particular deployment from a principal.
	DriverRevokeDeploymentAccess(context.Context, *DriverRevokeDeploymentAccessRequest) (*DriverRevokeDeploymentAccessResponse, error)
}
...
func (UnimplementedProvisionerServer) DriverGrantDeploymentAccess(context.Context, *DriverGrantDeploymentAccessRequest) (*DriverGrantDeploymentAccessResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DriverGrantDeploymentAccess not implemented")
}
func (UnimplementedProvisionerServer) DriverRevokeDeploymentAccess(context.Context, *DriverRevokeDeploymentAccessRequest) (*DriverRevokeDeploymentAccessResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DriverRevokeDeploymentAccess not implemented")
}
...
func _Provisioner_DriverGrantDeploymentAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DriverGrantDeploymentAccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProvisionerServer).DriverGrantDeploymentAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/deployment.v1alpha1.Provisioner/DriverGrantDeploymentAccess",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProvisionerServer).DriverGrantDeploymentAccess(ctx, req.(*DriverGrantDeploymentAccessRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Provisioner_DriverRevokeDeploymentAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DriverRevokeDeploymentAccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProvisionerServer).DriverRevokeDeploymentAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/deployment.v1alpha1.Provisioner/DriverRevokeDeploymentAccess",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProvisionerServer).DriverRevokeDeploymentAccess(ctx, req.(*DriverRevokeDeploymentAccessRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Provisioner_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DriverGrantDeploymentAccess",
			Handler:    _Provisioner_DriverGrantDeploymentAccess_Handler,
		},
		{
			MethodName: "DriverRevokeDeploymentAccess",
			Handler:    _Provisioner_DriverRevokeDeploymentAccess_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "spec/deployment.proto",
